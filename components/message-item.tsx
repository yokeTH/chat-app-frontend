...
export default function MessageItem({ message, isOwnMessage, onAddReaction, currentUser }: MessageItemProps) {
      ...
      <div className={cn("flex flex-col", isOwnMessage ? "items-end" : "")}>
        ...
        <div className="relative">
          <div
            ...
            className={cn("rounded-lg p-3", isOwnMessage ? "bg-primary text-primary-foreground" : "bg-muted")}
          >
            {message.content}
          </div>
