...
export const mockConversations: Conversation[] = [
  // Direct message with John
  {
    ...
    messages: [
      ...
      createMessage(
        'msg-3',
        'Great! Can you share your progress?',
        mockUsers[1],
        new Date(Date.now() - 3600000 * 22)
      ),
      createMessage(
        'msg-4',
        "Sure, I'll send you the files soon.",
        mockUsers[0],
        new Date(Date.now() - 3600000 * 21)
      ),
      createMessage(
        'msg-5',
  ...
  // Direct message with Jane
  {
    ...
    messages: [
      createMessage(
        'msg-16',
        'Did you review the document I sent?',
        mockUsers[2],
        new Date(Date.now() - 3600000 * 5)
      ),
      createMessage(
